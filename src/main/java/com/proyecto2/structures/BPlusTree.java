...
public class BPlusTree<T> {
    ...
    /**
     * Given a list of pointers to Node objects, this method returns the index
     * of the pointer that points to the specified 'node' LeafNode object.
     *
     ...
     * @return the floating point value associated with the key within the B+
     * tree
     */
